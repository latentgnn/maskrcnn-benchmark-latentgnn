...
# ---------------------------------------------------------------------------- #
# Feature Augmentation(S.Y.Zhang)
# ---------------------------------------------------------------------------- #
_C.MODEL.FEATURE_AUG = CN()
_C.MODEL.FEATURE_AUG.NAME = 'LatentGNN' # 'NonLocal'  
_C.MODEL.FEATURE_AUG.LR_FACTOR = 1.0
# LatentGNN Config
_C.MODEL.FEATURE_AUG.LATENTGNN = CN()
_C.MODEL.FEATURE_AUG.LATENTGNN.CHANNEL_STRIDE = [8,8,8,8]
_C.MODEL.FEATURE_AUG.LATENTGNN.LATENT_DIM = [150,150,100,50] #[200,150,100,50]
_C.MODEL.FEATURE_AUG.LATENTGNN.NUM_LATENT_KERNEL = 1
_C.MODEL.FEATURE_AUG.LATENTGNN.MODE = 'asymmetric'
_C.MODEL.FEATURE_AUG.LATENTGNN.GRAPH_CONV_FLAG = True
_C.MODEL.FEATURE_AUG.LATENTGNN.BN = 'FrozenBatchNorm2d'

# GroupLatentGNN Config
_C.MODEL.FEATURE_AUG.GROUP_LATENTGNN = CN()
_C.MODEL.FEATURE_AUG.GROUP_LATENTGNN.NUM_GROUP = [8,8,8,8]
_C.MODEL.FEATURE_AUG.GROUP_LATENTGNN.LATENT_DIM = [150,150,100,50] #[200,150,100,50]
_C.MODEL.FEATURE_AUG.GROUP_LATENTGNN.NUM_LATENT_KERNEL = 1
_C.MODEL.FEATURE_AUG.GROUP_LATENTGNN.MODE = 'asymmetric'
_C.MODEL.FEATURE_AUG.GROUP_LATENTGNN.GRAPH_CONV_FLAG = True
_C.MODEL.FEATURE_AUG.GROUP_LATENTGNN.BN = 'FrozenBatchNorm2d'