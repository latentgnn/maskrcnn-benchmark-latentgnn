...
@C2_FORMAT_LOADER.register("R-50-FPN-A3")
@C2_FORMAT_LOADER.register("R-50-FPN-A4")
@C2_FORMAT_LOADER.register("R-50-FPN-A5")
@C2_FORMAT_LOADER.register("R-50-FPN-A345")
@C2_FORMAT_LOADER.register("R-101-FPN-A3")
@C2_FORMAT_LOADER.register("R-101-FPN-A4")
@C2_FORMAT_LOADER.register("R-101-FPN-A5")
@C2_FORMAT_LOADER.register("R-101-FPN-A345")
@C2_FORMAT_LOADER.register("R-152-FPN-A3")
@C2_FORMAT_LOADER.register("R-152-FPN-A4")
@C2_FORMAT_LOADER.register("R-152-FPN-A5")
@C2_FORMAT_LOADER.register("R-152-FPN-A345")
def load_resnet_c2_format(cfg, f):
    state_dict = _load_c2_pickled_weights(f)
    conv_body = cfg.MODEL.BACKBONE.CONV_BODY
    # arch = conv_body.replace("-C4", "").replace("-C5", "").replace("-FPN", "")
    arch = conv_body.replace("-C4", "").replace("-C5", "").replace("-FPN", "").replace("-A345","").replace("-A34","").replace("-A3","").replace("-A4","").replace("-A5","")
