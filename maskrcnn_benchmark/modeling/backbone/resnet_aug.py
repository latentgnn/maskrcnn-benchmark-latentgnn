...
StageSpec = namedtuple(
    ...
    [
        ...
        "feature_aug", # True => add feature augment
    ],
)
...
ResNet50FPNStagesTo5A3 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 4, True, True), (3, 6, True, False), (4, 3, True, False))
)
ResNet50FPNStagesTo5A4 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 4, True, False), (3, 6, True, True), (4, 3, True, False))
)
ResNet50FPNStagesTo5A5 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 4, True, False), (3, 6, True, False), (4, 3, True, True))
)
ResNet50FPNStagesTo5A345 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 4, True, True), (3, 6, True, True), (4, 3, True, True))
)

# ResNet-101-FPN (including all stages)
ResNet101FPNStagesTo5A3 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 4, True, True), (3, 23, True, False), (4, 3, True, False))
)
ResNet101FPNStagesTo5A4 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 4, True, False), (3, 23, True, True), (4, 3, True, False))
)
ResNet101FPNStagesTo5A5 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 4, True, False), (3, 23, True, False), (4, 3, True, True))
)
ResNet101FPNStagesTo5A345 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 4, True, True), (3, 23, True, True), (4, 3, True, True))
)

# ResNet-152-FPN (including all stages)
ResNet152FPNStagesTo5A3 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 8, True, True), (3, 36, True, False), (4, 3, True, False))
)
ResNet152FPNStagesTo5A4 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 8, True, False), (3, 36, True, True), (4, 3, True, False))
)
ResNet152FPNStagesTo5A5 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 8, True, False), (3, 36, True, False), (4, 3, True, True))
)
ResNet152FPNStagesTo5A345 = tuple(
    StageSpec(index=i, block_count=c, return_features=r, feature_aug=f)
    for (i, c, r, f) in ((1, 3, True, False), (2, 8, True, True), (3, 36, True, True), (4, 3, True, True))
)
...
_STAGE_SPECS = Registry({
    "R-50-FPN-A3": ResNet50FPNStagesTo5A3,
    "R-50-FPN-A4": ResNet50FPNStagesTo5A4,
    "R-50-FPN-A5": ResNet50FPNStagesTo5A5,
    "R-50-FPN-A345": ResNet50FPNStagesTo5A345,
    
    "R-101-FPN-A3": ResNet101FPNStagesTo5A3,
    "R-101-FPN-A4": ResNet101FPNStagesTo5A4,
    "R-101-FPN-A5": ResNet101FPNStagesTo5A5,
    "R-101-FPN-A345": ResNet101FPNStagesTo5A345,

    "R-152-FPN-A3": ResNet152FPNStagesTo5A3,
    "R-152-FPN-A4": ResNet152FPNStagesTo5A4,
    "R-152-FPN-A5": ResNet152FPNStagesTo5A5,
    "R-152-FPN-A345": ResNet152FPNStagesTo5A345,
