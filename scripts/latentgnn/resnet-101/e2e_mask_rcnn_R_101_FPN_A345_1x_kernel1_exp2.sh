...
export NGPUS=8
CONFIG="configs/latentgnn/R-101/e2e_mask_rcnn_R_101_FPN_A345_1x.yaml"
DEBUG_IMAGE_BATCH=2
MASTER_ADDR=$2 # MASTER_ADDR="12.12.12.124"
RANK=$3 # RANK=0
MORE_ARGS='MODEL.FEATURE_AUG.LATENTGNN.CHANNEL_STRIDE [16,16,16,16]
           MODEL.FEATURE_AUG.LATENTGNN.BN "nn.BatchNorm2d"'
...
OUTPUT_FOLDER=./save/latentgnn/resnet-101/e2e_mask_rcnn_R_101_FPN_A345_1x_kernel1_exp2_nogamma
