...
export NGPUS=4
CONFIG="configs/latentgnn/R-50/e2e_mask_rcnn_R_50_FPN_A5_1x.yaml"
DEBUG_IMAGE_BATCH=2
...
OUTPUT_FOLDER=./save/latentgnn/resnet-50/e2e_mask_rcnn_R_50_FPN_A5_1x_kernel1_latentoriginal_exp1
