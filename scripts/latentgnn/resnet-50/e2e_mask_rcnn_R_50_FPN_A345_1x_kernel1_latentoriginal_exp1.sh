...
export NGPUS=4
CONFIG="configs/latentgnn/R-50/e2e_mask_rcnn_R_50_FPN_A345_1x.yaml"
DEBUG_IMAGE_BATCH=2
MASTER_ADDR=$2 # MASTER_ADDR="12.12.12.124"
RANK=$3 # RANK=0
MORE_ARGS='MODEL.FEATURE_AUG.LATENTGNN.CHANNEL_STRIDE [8,8,8,8]
           MODEL.FEATURE_AUG.NAME LatentGNNOriginal'
        #    MODEL.FEATURE_AUG.LR_FACTOR 5.0' 
...
OUTPUT_FOLDER=./save/latentgnn/resnet-50/e2e_mask_rcnn_R_50_FPN_A345_1x_kernel1_latentoriginal_exp1
