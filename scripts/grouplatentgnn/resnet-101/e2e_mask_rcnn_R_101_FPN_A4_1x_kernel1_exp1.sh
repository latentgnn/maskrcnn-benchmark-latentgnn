...
export NGPUS=8
CONFIG="configs/grouplatentgnn/R-101/e2e_mask_rcnn_R_101_FPN_A4_1x.yaml"
DEBUG_IMAGE_BATCH=2
...
OUTPUT_FOLDER=./save/grouplatentgnn/resnet-101/e2e_mask_rcnn_R_101_FPN_A4_1x_kernel1_exp1
