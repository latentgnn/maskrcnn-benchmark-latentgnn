...
export NGPUS=4
CONFIG="configs/grouplatentgnn/R-50/e2e_mask_rcnn_R_50_FPN_A3_1x.yaml"
DEBUG_IMAGE_BATCH=2
MASTER_ADDR=$2 # MASTER_ADDR="12.12.12.124"
RANK=$3 # RANK=0
MORE_ARGS=''
        #  MODEL.FEATURE_AUG.LATENTGNN.CHANNEL_STRIDE [16,16,16,16]' 
...
OUTPUT_FOLDER=./save/grouplatentgnn/resnet-50/e2e_mask_rcnn_R_50_FPN_A3_1x_kernel1_exp1
