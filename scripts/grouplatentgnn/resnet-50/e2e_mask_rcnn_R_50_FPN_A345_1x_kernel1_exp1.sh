...
export NGPUS=4
CONFIG="configs/grouplatentgnn/R-50/e2e_mask_rcnn_R_50_FPN_A345_1x.yaml"
DEBUG_IMAGE_BATCH=2
...
OUTPUT_FOLDER=./save/grouplatentgnn/resnet-50/e2e_mask_rcnn_R_50_FPN_A345_1x_kernel1_exp1
